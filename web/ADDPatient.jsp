...
<%
String studentID = request.getParameter("EmployeeID");
String courseID = request.getParameter("courseList");

String insertSql = "INSERT INTO PatientEmployee(EmployeeID, PatientID) VALUES (?, ?)";
...
response.sendRedirect("DetailEmployee.jsp?EmployeeID=" + studentID);
%>
